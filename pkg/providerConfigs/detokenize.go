	...
	return filepath.WalkFunc(func(path string, fi os.FileInfo, err error) error {
		...
		if matched {
			...
			if !strings.Contains(path, "/.git/") {
				...
				newContents = strings.Replace(newContents, "<WORKLOAD_CLUSTER_TERRAFORM_MODULE_URL>", "git::https://github.com/kubewhatever-com/gitops//terraform/digitalocean/modules/workload-cluster?ref=main", -1)
